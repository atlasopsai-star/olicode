...
const TIPS: Tip[] = [
  ...
  "Create {highlight}olicode.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "Place TUI settings in {highlight}~/.config/olicode/tui.json{/highlight} for global config",
  ...
  "Create a plugin to prevent OliCode from reading sensitive files",
  "Use {highlight}olicode run{/highlight} for non-interactive scripting",
  "Use {highlight}olicode --continue{/highlight} to resume the last session",
  "Use {highlight}olicode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}olicode serve{/highlight} for headless API access to OliCode",
  "Use {highlight}olicode run --attach{/highlight} to connect to a running server",
  "Run {highlight}olicode upgrade{/highlight} to update to the latest version",
  "Run {highlight}olicode auth list{/highlight} to see all configured providers",
  "Run {highlight}olicode agent create{/highlight} for guided agent creation",
  "Use {highlight}/olicode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}olicode github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/olicode fix this{/highlight} on issues to auto-create PRs",
  ...
  "Run {highlight}olicode debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/atlasopsai/olicode{/highlight} for containerized use",
  "OliCode supports 75+ AI providers — use {highlight}/connect{/highlight} to add any model you want",
